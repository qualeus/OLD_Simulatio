...
sf::Vector2f ftn::Norme(const sf::Vector2f &vect_A, const sf::Vector2f &vect_B) { return sf::Vector2f(vect_A.y - vect_B.y, vect_B.x - vect_A.x); }

/* Return the inverse Norme = [Ay - By, Bx - Ax] */
sf::Vector2f ftn::inverse_Norme(const sf::Vector2f &vect_A, const sf::Vector2f &vect_B) { return sf::Vector2f(vect_B.y - vect_A.y, vect_A.x - vect_B.x); }
...
sf::Vector2f ftn::Mirrored_Point(const sf::Vector2f &vect_A, const sf::Vector2f &vect_B) { return 2.0f * ftn::Line_Projection(vect_A, vect_B) - vect_A; }
