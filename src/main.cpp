...
int main()
{
	...
	Renderer test = Renderer("Test", false, 0.0f, 0.4f);
	...
	for (int i = 0; i < 300; ++i) { test.system.addCorpse(phy::Circle(rand() % 500 + 250, rand() % 500, rand() % 10 + 15, 5, 2, 0, 0, false, false, sf::Color::Blue)); }
