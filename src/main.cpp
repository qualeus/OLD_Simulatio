...
int main()
{
	...
	Renderer test = Renderer("Test", false, 0.0f, 1.0f);

	test.system.addCorpse(phy::Circle(500, 100, 40, 5, 1, 0, 0, false, false, sf::Color::Red));

	for (int i = 0; i < 600; ++i) { test.system.addCorpse(phy::Circle(rand() % 500 + 250, rand() % 500, rand() % 20 + 5, 5, 1, 0, 0, false, false, sf::Color::Blue)); }
