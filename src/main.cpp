...
int main()
{
	...
	*/
	test.system.addCorpse(phy::Polygon({{750, 750},{950, 750},{950, -350},{750, -350}}, 5, 1, 10, -50, true, false, C_NEPHRITIS));
	test.system.addCorpse(phy::Polygon({{-150, 750},{50, 750},{50, -350},{-150, -350}}, 5, 1, 10, -50, true, false, C_NEPHRITIS));
	test.system.addCorpse(phy::Polygon({{-150, 950},{950, 950},{950, 750},{-150, 750}}, 5, 1, 10, -50, true, false, C_NEPHRITIS));
	
	//test.system.addCorpse(phy::Polygon({{850, 750},{50, 750},{50, 650},{850, 650}}, 5, 1, 10, -50, true, false, C_NEPHRITIS));
	//test.system.addCorpse(phy::Polygon({{-50, 750},{-50, -350},{50, -350},{50, 650},{850, 650}}, 5, 1, 10, -50, true, false, C_NEPHRITIS));
	
	test.system.addCorpse(phy::Polygon({{600, 50},{720, 90},{820, -150},{590, -10}}, 5, 1, 10, -50, true, false, sf::Color::Green));
	test.system.addCorpse(phy::Polygon({{0, 0},{0, 200},{200, 200},{200, 0}}, 5, 1, 10, -50, true, false, C_CARROT));
